...
Pascal Delphi translation by Patrick Chevalley
November 1999
http://astrosurf.org/astropc

Computation of geocentric lunar coordinates from ELP 2000-82 and ELP2000-85 
theories (M. Chapront-Touze and J. Chapront). 
Constants fitted to JPL's ephemerides DE200/LE200.

The original Fortran program elp82b.f is converted in Pascal, all the series 
files are include in structure in the DLL with all terms down to a precision 
of 10-8 assuring some hundredth of arc seconds of precision.
