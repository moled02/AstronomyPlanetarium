...
Begin VB.Form frmPlanets 
   ...
   Begin VB.ListBox List1 
      ...
      ForeColor       =   &H00000000&
      Height          =   6360
      ItemData        =   "frmPlanets.frx":030A
      Left            =   120
      List            =   "frmPlanets.frx":030C
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.ComboBox Combo1 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "frmPlanets.frx":030E
         Left            =   120
         List            =   "frmPlanets.frx":0310
         TabIndex        =   19
         Text            =   "Combo1"
         Top             =   2040
         Width           =   1935
   ...
   Begin VB.Frame DateTime1Frame 
      ...
      Begin VB.ComboBox MonthSelect 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "frmPlanets.frx":0312
         Left            =   720
         List            =   "frmPlanets.frx":0314
      ...
      Begin VB.ComboBox DaySelect 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "frmPlanets.frx":0316
         Left            =   120
         List            =   "frmPlanets.frx":0318
         Style           =   2  'Dropdown List
         TabIndex        =   0
         Top             =   240
         Width           =   615
...
List1.AddItem "Maan appearent: " + StrHMS_DMS(RA * 180 / Pi, 7, 3, False, False, "h", 2) + vbTab + StrHMS_DMS(Decl * 180 / Pi, 7, 2, True, False, "g", 3)
...
List1.AddItem "Position Angle: " + StrHMS_DMS(MoonPhysData.X * 180 / Pi, 3, 0, True, False, "g", 3)
